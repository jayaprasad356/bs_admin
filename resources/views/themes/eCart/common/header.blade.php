...
<body>
    <div id="wrapper">
        ...
        <div class="loader">
            <img src="{{ (_asset(Cache::get('loading')) == '') ? _asset(Cache::get('loading') == '') : URL::asset('images/placeholder.png') }}" alt="preloader">
        </div>
                                ...
                                <div class="header_social_icon text-end">
                                    <ul>
                                        @foreach (Cache::get('social_media') as $i => $c)
                                            <li><a href="{{ $c->link }}" target="_blank"><em
                                                        class="fab {{ $c->icon }}"></em></a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            @endif
                                    ...
                                    <div class="col d-flex justify-content-center pin__code">
                                        @if (isset($data['carticon']) && $data['carticon'] == 0)
                                            <button type="button" class="btn hide" data-bs-toggle="modal"
                                                ...
                                                <em class="fas fa-map-marker-alt">&nbsp;{{ __('msg.deliver to') }}
                                                    {{ session()->get('pincode_no') ?? 'All' }}</em>
                                            </button>
                                        @else
                                            @if (Cache::get('local_shipping') == '1')
                                            ...
                                            <form action="{{ route('shop') }}">
                                                <div class="category_hover_content">
                                                    ...
                                                    <select class="" name="category">
                                                        ...
                                                        <option>{{ __('msg.all_categories') }}</option>
                                                ...
                                                <div class="search-box">
                                                    <input placeholder="Search product..."
                                                        value="{{ isset($_GET['s']) ? trim($_GET['s']) : '' }}"
                                        ...
                                        <div class="header_account_area">
                                            <div class="header_account_list register login-sec">
                                                @if (isLoggedIn())
                                                    <ul>
                                                        <li>
                                                            <a class="profile__name">{{ __('msg.hello') }}
                                                                {{ strlen($user->name) > 10 ? substr($user->name, 0, 10) . '...' : $user->name }}
                                                                ...
                                                                <li>
                                                                    <a href="{{ route('my-account') }}">
                                                                        <span class="my-profile-img"><img
                                                                                class="lazy"
                                                                                data-original="{{ $user->profile }}"
                                                                                alt="profile"></span>
                                                                        <span
                                                                            class="side-menu account-profile ">{{ __('msg.my_profile') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('change-password') }}"><em
                                                                            class="fas fa-key"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.change_password') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('my-orders') }}"><em
                                                                            class="far fa-list-alt"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.my_orders') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('wallet-history') }}"><em
                                                                            class="far fa-list-alt"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.wallet_history') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('notification') }}"><em
                                                                            class="fa fa-bell"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.notifications') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('favourite') }}"><em
                                                                            class="fa fa-heart"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.favourite') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('transaction-history') }}"><em
                                                                            class="fa fa-outdent"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.transaction_history') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('refer-earn') }}"><em
                                                                            class="fas fa-rupee-sign"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.refer_and_earn') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('addresses') }}"><em
                                                                            class="fa fa-wrench"></em>
                                                                        <span
                                                                            class="side-menu">{{ __('msg.manage_addresses') }}</span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="{{ route('logout') }}"><em
                                                                        ...
                                                                        <span
                                                                            class="side-menu">{{ __('msg.logout') }}</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    ...
                                                    @if (isset($data['cart']['cart']['data']) &&
                                                        ...
                                                        @else
                                                            <span class="item_count"
                                                                id="item_count">{{ $data['cart']['cart']['total'] }}</span>
                                                        @endif
                                                    @endif
                                                </span>
                                            </a>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @if (isset($data['cart']['cart']['data']) &&
                                                                        ...
                                                                        @if (isset($p->item[0]))
                                                                            ...
                                                                            <tr class="cart1price">
                                                                                <td class="text-end checktrash cart">
                                                                                    @if (isset($p->item[0]->is_item_deliverable) &&
                                                                                        $p->item[0]->is_item_deliverable == false &&
                                                                                        session()->get('pincode_no') == true)
                                                                                        <p class="deliver_notice">
                                                                                            {{ __('msg.Not Deliverable for') }}
                                                                                            {{ session()->get('pincode_no') }}
                                                                                        </p>
                                                                                    ...
                                                                                    <a href="">
                                                                                        <figure class="itemside">
                                                                                            ...
                                                                                            <figcaption
                                                                                                ...
                                                                                                <span
                                                                                                    class="small">{{ get_varient_name($p->item[0]) ?? '-' }}</span>
                                                                                                <br />
                                                                                                <span
                                                                                                    class="price-wrap cartShow">{{ $qty ?? '1' }}</span>
                                                                                                <form
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <button
                                                                                                            ...
                                                                                                            type="button"
                                                                                                            id="button-minus-{{ $p->product_variant_id }}"
                                                                                                            value="-">-</button>
                                                                                                        <input
                                                                                                            ...
                                                                                                            data-max-allowed="{{ Cache::get('max_cart_items_count') }}"
                                                                                                            value="{{ $qty ?? '1' }}"
                                                                                                            readonly>
                                                                                                        <button
                                                                                                            class="cart-qty-plus button-plus-cart"
                                                                                                            type="button"
                                                                                                            id="button-plus-{{ $p->product_variant_id }}"
                                                                                                            value="+">+</button>
                                                                                                    </div>
                                                                                                </form>
                                                                                                @if (intval($qty ?? '1') > 1)
                                                                    ...
                                                                    <button class="btn btn-light btn-round cartDelete"
                                                                        data-varient="{{ $p->product_variant_id }}">
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="4" class="text-center">
                                                        ...
                                                        <br><br>
                                                        <a href="{{ route('shop') }}" class="btn btn-primary"><em
                                                            ...
                                                            <td colspan="" class="text-end checkoutbtn">
                                                                @if (Cache::has('min_order_amount') &&
                                                                    ...
                                                                    @if (session()->has('pincode') && Cache::get('local_shipping') == '1')
                                                                        ...
                                                                        @else
                                                                            <a
                                                                                class="btn btn-primary checkout-dbutton">{{ __('msg.checkout') }}
                                                                                <em class="fa fa-arrow-right"></em>
                                                                            </a>
                                                                        @endif
                                                                    @elseif(Cache::get('local_shipping') == '1')
                                                                        <a
                                                                            class="btn btn-primary checkout-spincode-button">{{ __('msg.checkout') }}
                                                                ...
                                                                <a href="{{ route('cart') }}"
                                                                    class="btn btn-primary">{{ __('msg.viewcart') }}
                                                                    <em class="fa fa-arrow-right"></em>
                                                                </a>
                                                            </td>
                                        ...
                                        @else
                                            <div class="text-center mini_no_cart">
                                                <img src="{{ asset('images/empty-cart.png') }}"
                                                    alt="No Items In Cart">
                                                <br><br>
                                                <a href="{{ route('shop') }}" class="btn btn-primary text-white"><em
                                                        class="fa fa-chevron-left  mr-1"></em>{{ __('msg.continue_shopping') }}</a>
                                            </div>
                                            @endif
                                        </div>
                    ...
                    <div class="categories_menu">
                        ...
                        <div class="title_content">
                            ...
                            <h2 class="categories_toggle"><em
                                    class="fas fa-bars"></em>{{ __('msg.all_categories') }}</h2>
                            ...
                            <ul>
                                @foreach ($categories as $k => $c)
                                    ...
                                    @if (isset($c->childs) && count((array) $c->childs))
                                        <li
                                            class="menu_item_content has_child {{ $loop->index >= $maxProductToShowhere ? 'hidden' : '' }}">
                                            <a href="{{ route('category', $c->slug) }}">{{ $c->name }}</a><em
                                    ...
                                    @else
                                        <li
                                            class="menu_item_content not_child {{ $loopn >= $maxProductToShowhere ? 'hidden' : '' }}">
                    ...
                    <div class="main_menu_content main_menu_position">
                        <nav>
                            <ul>
                                <li>
                                    <a href="{{ route('home') }}"
                                        class="{{ request()->is('/') ? 'active' : '' }}">{{ __('msg.home') }}
                                    </a>
                                </li>
                                <li class="mega_items_content"><a href="{{ route('shop') }}"
                                        class="{{ request()->is('shop') ? 'active' : '' }}">{{ __('msg.shop') }}</a>
                                </li>
                                <li>
                                    <a>{{ __('msg.more') }}<em class="fa fa-angle-down"></em></a>
                                    <ul class="sub_menu pages">
                                        <li><a href="{{ route('about') }}"
                                                class="{{ request()->is('about') ? 'active' : '' }}">{{ __('msg.about us') }}</a>
                                        </li>
                                        <li><a href="{{ route('page', 'faq') }}"
                                                class="{{ request()->is('page/contact') ? 'active' : '' }}">{{ __('msg.faq') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
    ...
    <div id='loader2'>
        <img src="{{ (asset('images/loading.gif') == '') ? asset('images/loading.gif') : URL::asset('images/headerlogo.png')  }}" id="preloader" alt="preloader">
    </div>
                    ...
                    <div class="wrapper-dropdown-5 dd" tabindex="1">
                        @if (Cache::has('locations') && is_array(Cache::get('locations')) && !empty(Cache::get('locations')['data']))
                            <input class="inP live-search-box form-control" type="text" name="selected_pincode"
                                placeholder="{{ session()->get('pincode_no') }}" autocomplete="off"
                                onkeyup="searchclick()" id="searchclick">
                            <ul class="dropdown live-search-list">
                                <li class="item">
                                    <a class="close-pincode-modal" href="{{ route('home-pincode-clear') }}">
                                        {{ __('msg.all') }}</a>
                                </li>
                                    ...
                                    @if (!empty($loc->pincode))
                                        <li class="item">
                                            <a class="close-pincode-modal"
                                                href="{{ route('home-pincode', $loc->id) }}">{{ $loc->pincode }}</a>
                                        </li>
                                    @endif
                                @endforeach
                            </ul>
