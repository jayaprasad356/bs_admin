      ...
      <div class="footer-inner">
         ...
         <div class="footer-bottom ">
            <div class="row mtb-30">
               ...
               <div class="col-md-4 col-12 ">
                  <div class="copy-right ">{{__('msg.copyright')}} &copy; {{date('Y')}} {{__('msg.made')}} <a href="{{ Cache::get('copy_right_url') }}" target="_blank" rel="noopener noreferrer">{{ Cache::get('copy_right_title') }}.</a>
                  </div>
               </div>
               <div class="col-md-4 col-12">
                  <div class="payment">
