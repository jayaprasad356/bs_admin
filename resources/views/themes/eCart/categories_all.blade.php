                            ...
                            <div class="pop_item-listcategories">
                                <div class="pop_list-categories">
                                    <div class="pop_thumb-category">
                                        <a href="{{ route('category', $c->slug) }}"><img class="lazy" data-original="{{ $c->web_image }}" alt="{{ $c->name ?? 'Category' }}"></a>
                                    </div>
                                    <div class="pop_desc_listcat">
                                        ...
                                        <div class="view-more"><a href="{{ route('category', $c->slug) }}">{{__('msg.shop_now')}} &nbsp;<em class="fas fa-chevron-circle-right"></em></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
