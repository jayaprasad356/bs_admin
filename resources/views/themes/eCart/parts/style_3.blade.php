            ...
            <div class="container-fluid">
                <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                    <div class="section_title d-flex mb-3 align-items-baseline border-bottom">
                        <h2><span
                                class="border-bottom border-primary border-width-2 pb-3 d-inline-block">{{ $s->title }}</span>
                        </h2>
                        <div class="pop_desc_title">
                            @if (isset($s->slug) && $s->slug != '')
                                <a href="{{ route('shop', ['section' => $s->slug]) }}"
                                    class="view title-section view-all ml-auto mr-0 btn btn-primary btn-sm shadow-md w-100 w-md-auto">{{ __('msg.view_all') }}&nbsp;&nbsp;<i
                    ...
                    <div class="row ">
                        <div class="col-12">
                            <div class="featured_product_area product_carousel featured-product owl-carousel">
                                @php
                                    $maxProductShow = get('style_3.max_product_on_homne_page');
                                    $i = 0;
                                @endphp
                                                    ...
                                                    <figure>
                                                        ...
                                                        <figcaption class="product_content">
                                                            <h4 class="product_name"><a
                                                                    href="{{ route('product-single', $p->slug) }}">
                                                                    @if (strlen(strip_tags($p->name)) > 25)
                                                                        {!! substr(strip_tags($p->name), 0, 25) . '...' !!}
                                                                    @else
                                                                        {!! substr(strip_tags($p->name), 0, 25) !!}
                                                                    @endif
                                                                </a>
                                                                ...
                                                                <span class="inner product_data">
                                                                    <ul>
                                                                        ...
                                                                        @else
                                                                            <li class="wishlist"><a
                                                                                    title="Add to Wishlist"
                                                                                    class="{{ isset($p->is_favorite) && intval($p->is_favorite) ? 'saved' : 'save' }}"
                                                                                    data-id='{{ $p->id }}'></a>
                                                                            </li>
                                                                        @endif
                                                                    </ul>
                                                            ...
                                                            <div class="price_box">
                                                                <span
                                                                    class="current_price">{!! print_price($p) !!}</span>
