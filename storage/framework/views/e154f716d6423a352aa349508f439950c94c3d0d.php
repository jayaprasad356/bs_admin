                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <div class="row bg-white shadow rounded ">
                            <div class="col justify-content-center align-items-center my-3">
                                <p class="text-center"><?php echo e(__('msg.no_favorites_product_found')); ?></p>
                            </div>
                        </div>
                        <?php endif; ?>
...
<?php /**PATH /home/u743445510/domains/graymatterworks.com/public_html/ecartwebsite/resources/views/themes/eCart/user/favorites.blade.php ENDPATH**/ ?>