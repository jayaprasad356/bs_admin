      ...
      <div class="footer-inner">
               ...
               <div class="col f-col">
                  <div class="footer-static-block">
                     ...
                     <div class="f-logo">
                        ...
                        <img src="<?php echo e((_asset(Cache::get('web_logo')) == '') ? _asset(Cache::get('web_logo')) : URL::asset('images/headerlogo.png')); ?>" alt="Logo">
                        </a>
                     </div>
         ...
         <div class="footer-bottom ">
            <div class="row mtb-30">
               ...
               <div class="col-md-4 col-12 ">
                  <div class="copy-right "><?php echo e(__('msg.copyright')); ?> &copy; <?php echo e(date('Y')); ?> <?php echo e(__('msg.made')); ?> <a href="<?php echo e(Cache::get('copy_right_url')); ?>" target="_blank" rel="noopener noreferrer"><?php echo e(Cache::get('copy_right_title')); ?>.</a>
                  </div>
               </div>
               <div class="col-md-4 col-12">
                  <div class="payment">
...
<!-- color switcher -->
<?php if(Cache::get('show_color_picker_in_website')=='1'): ?>
...
<?php /**PATH /home/u743445510/domains/graymatterworks.com/public_html/ecartwebsite/resources/views/themes/eCart/common/footer.blade.php ENDPATH**/ ?>