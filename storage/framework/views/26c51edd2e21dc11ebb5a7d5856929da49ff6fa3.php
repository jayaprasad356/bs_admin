...
<body>
    <div id="wrapper">
        ...
        <div class="loader">
            <img src="<?php echo e((_asset(Cache::get('loading')) == '') ? _asset(Cache::get('loading') == '') : URL::asset('images/placeholder.png')); ?>" alt="preloader">
        </div>
                        ...
                        <div class="mobile_wrapper">
                                ...
                                <div class="header_social_icon text-end">
                                    <ul>
                                        <?php $__currentLoopData = Cache::get('social_media'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li><a href="<?php echo e($c->link); ?>" target="_blank"><em
                                                        class="fab <?php echo e($c->icon); ?>"></em></a></li>
                            ...
                            <div class="col-lg-12">
                                <p class="text-center"><a href="#"><em class="fas fa-envelope"></em>
                                        <?php echo e(Cache::get('support_email')); ?></a></p>
                            </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class="col-lg-2 col-md-3 col-sm-3 col-12">
                                <div class="logo">
                                    <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e((_asset(Cache::get('web_logo')) == '') ? _asset(Cache::get('web_logo')) : URL::asset('images/headerlogo.png')); ?>" alt="Logo"></a>
                                </div>
                            </div>
                                ...
                                <div class="content_right_info">
                                    <div class="col d-flex justify-content-center pin__code">
                                        <?php if(isset($data['carticon']) && $data['carticon'] == 0): ?>
                                            <button type="button" class="btn hide" data-bs-toggle="modal"
                                                data-bs-target="#pincodeModal">
                                                <em class="fas fa-map-marker-alt">&nbsp;<?php echo e(__('msg.deliver to')); ?>

                                                    <?php echo e(session()->get('pincode_no') ?? 'All'); ?></em>
                                            </button>
                                        <?php else: ?>
                                            <?php if(Cache::get('local_shipping') == '1'): ?>
                                            ...
                                            <form action="<?php echo e(route('shop')); ?>">
                                                <div class="category_hover_content">
                                                    ...
                                                    <select class="" name="category">
                                                        ...
                                                        <option><?php echo e(__('msg.all_categories')); ?></option>
                                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($c->slug); ?>"
                                                                <?php if((isset($_GET['category']))&& $_GET['category'] == $c->slug){
                                                                echo 'selected';
                                                            } ?>>
                                                ...
                                                <div class="search-box">
                                                    <input placeholder="Search product..."
                                                        value="<?php echo e(isset($_GET['s']) ? trim($_GET['s']) : ''); ?>"
                                                        name="s" type="text" class="typeahead"
                                        ...
                                        <div class="header_account_area">
                                            <div class="header_account_list register login-sec">
                                                <?php if(isLoggedIn()): ?>
                                                    <ul>
                                                        <li>
                                                            <a class="profile__name"><?php echo e(__('msg.hello')); ?>

                                                                <?php echo e(strlen($user->name) > 10 ? substr($user->name, 0, 10) . '...' : $user->name); ?>

                                                                <em class="fas fa-chevron-down fa-xs"></em></a>
                                                            <ul class="sub_menu myaccount">
                                                                <li>
                                                                    <a href="<?php echo e(route('my-account')); ?>">
                                                                        <span class="my-profile-img"><img
                                                                                class="lazy"
                                                                                data-original="<?php echo e($user->profile); ?>"
                                                                                alt="profile"></span>
                                                                        <span
                                                                            class="side-menu account-profile "><?php echo e(__('msg.my_profile')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('change-password')); ?>"><em
                                                                            class="fas fa-key"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.change_password')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('my-orders')); ?>"><em
                                                                            class="far fa-list-alt"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.my_orders')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('wallet-history')); ?>"><em
                                                                            class="far fa-list-alt"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.wallet_history')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('notification')); ?>"><em
                                                                            class="fa fa-bell"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.notifications')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('favourite')); ?>"><em
                                                                            class="fa fa-heart"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.favourite')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('transaction-history')); ?>"><em
                                                                            class="fa fa-outdent"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.transaction_history')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('refer-earn')); ?>"><em
                                                                            class="fas fa-rupee-sign"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.refer_and_earn')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('addresses')); ?>"><em
                                                                            class="fa fa-wrench"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.manage_addresses')); ?></span>
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                    <a href="<?php echo e(route('logout')); ?>"><em
                                                                            class="fa fa-sign-out-alt"></em>
                                                                        <span
                                                                            class="side-menu"><?php echo e(__('msg.logout')); ?></span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                ...
                                                <?php else: ?>
                                                    <a data-bs-toggle="modal" data-bs-target="#myModal"
                                                        data-tab="login"><em class="far fa-user "></em></a>
                                                <?php endif; ?>
                                            </div>
                                                    ...
                                                    <?php if(isset($data['cart']['cart']['data']) &&
                                                        ...
                                                        <?php else: ?>
                                                            <span class="item_count"
                                                                id="item_count"><?php echo e($data['cart']['cart']['total']); ?></span>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </span>
                                            </a>
                                                ...
                                                <?php if(isset($data['cart']['cart']) && is_array($data['cart']['cart']) && count($data['cart']['cart'])): ?>
                                                    ...
                                                    <div class="cart_gallery">
                                                        ...
                                                        <table id="myTable" class="table "
                                                            aria-describedby="minicart">
                                                            <th scope="col"></th>
                                                            <tbody>
                                                                <?php if(isset($data['cart']['cart']['data'][0]->item[0])): ?>
                                                                    <tr>
                                                                        <td class="mini_cart-subtotal">

                                                                            <span class="text-end innersubtotal">
                                                                                <p class="product-name">
                                                                                    <?php echo e(__('msg.total')); ?> :
                                                                ...
                                                                <?php if(isset($data['cart']['cart']['data']) &&
                                                                        ...
                                                                        <?php if(isset($p->item[0])): ?>
                                                                            ...
                                                                            <tr class="cart1price">
                                                                                <td class="text-end checktrash cart">
                                                                                    <?php if(isset($p->item[0]->is_item_deliverable) &&
                                                                                        $p->item[0]->is_item_deliverable == false &&
                                                                                        session()->get('pincode_no') == true): ?>
                                                                                        <p class="deliver_notice">
                                                                                            <?php echo e(__('msg.Not Deliverable for')); ?>

                                                                                            <?php echo e(session()->get('pincode_no')); ?>
                                                                                    ...
                                                                                    <a href="">
                                                                                        <figure class="itemside">
                                                                                            ...
                                                                                            <figcaption
                                                                                                class="info minicartinfo">
                                                                                                <a href=""
                                                                                                    class="title text-dark"><?php echo e($p->item[0]->name ?? '-'); ?></a>
                                                                                                <span
                                                                                                    class="small"><?php echo e(get_varient_name($p->item[0]) ?? '-'); ?></span>
                                                                                                <br />
                                                                                                <span
                                                                                                    class="price-wrap cartShow"><?php echo e($qty ?? '1'); ?></span>
                                                                                                <form
                                                                                                    action="<?php echo e(route('cart-update', $p->product_id)); ?>"
                                                                                                    method="POST"
                                                                                                    class="cartEdit cartEditmini">
                                                                                                    <?php echo csrf_field(); ?>
                                                                                                    <input
                                                                                                        type="hidden"
                                                                                                        name="child_id"
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="button-container col pr-0 my-1 mini_cart_button">
                                                                                                        <button
                                                                                                            class="cart-qty-minus button-minus"
                                                                                                            type="button"
                                                                                                            id="button-minus-<?php echo e($p->product_variant_id); ?>"
                                                                                                            value="-">-</button>
                                                                                                        <input
                                                                                                            class="form-control qtyPicker midd_button"
                                                                                                            type="number"
                                                                                                            name="qty"
                                                                                                            data-min="1"
                                                                                                            min="1"
                                                                                                            ...
                                                                                                            data-max-allowed="<?php echo e(Cache::get('max_cart_items_count')); ?>"
                                                                                                            value="<?php echo e($qty ?? '1'); ?>"
                                                                                                            readonly>
                                                                                                        <button
                                                                                                            class="cart-qty-plus button-plus-cart"
                                                                                                            type="button"
                                                                                                            id="button-plus-<?php echo e($p->product_variant_id); ?>"
                                                                                                            value="+">+</button>
                                                                                                    </div>
                                                                                                </form>
                                                                                                    ...
                                                                                                    <?php if(intval($p->item[0]->discounted_price)): ?>
                                                                                                        x<small
                                                                                                            ...
                                                                                                            <?php if(isset($p->item[0]->tax_percentage) && $p->item[0]->tax_percentage > 0): ?>
                                                                                                                ...
                                                                                                                ?>
                                                                                                                <?php echo e(get_price($tax_price)); ?>
                                                                    ...
                                                                    <button class="btn btn-light btn-round cartDelete"
                                                                        data-varient="<?php echo e($p->product_variant_id); ?>">
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="4" class="text-center">
                                                        ...
                                                        <br><br>
                                                        <a href="<?php echo e(route('shop')); ?>" class="btn btn-primary"><em
                                                        ...
                                                        <?php if(isset($data['cart']['cart']['data']) &&
                                                            ...
                                                            <td colspan="" class="text-end checkoutbtn">
                                                                <?php if(Cache::has('min_order_amount') &&
                                                                    intval($data['cart']['subtotal']) >= intval(Cache::get('min_order_amount'))): ?>
                                                                    <?php if(session()->has('pincode') && Cache::get('local_shipping') == '1'): ?>
                                                                        <?php if($ready_to_checkout == '1'): ?>
                                                                            <?php if(isLoggedIn()): ?>
                                                                                <a href="<?php echo e(route('checkout-address')); ?>"
                                                                        ...
                                                                        <?php else: ?>
                                                                            <a
                                                                                class="btn btn-primary checkout-dbutton"><?php echo e(__('msg.checkout')); ?>

                                                                                <em class="fa fa-arrow-right"></em>
                                                                            </a>
                                                                        <?php endif; ?>
                                                                    <?php elseif(Cache::get('local_shipping') == '1'): ?>
                                                                        <a
                                                                            class="btn btn-primary checkout-spincode-button"><?php echo e(__('msg.checkout')); ?>
                                                                ...
                                                                <a href="<?php echo e(route('cart')); ?>"
                                                                    class="btn btn-primary"><?php echo e(__('msg.viewcart')); ?>
                                        ...
                                        <?php else: ?>
                                            <div class="text-center mini_no_cart">
                                                <img src="<?php echo e(asset('images/empty-cart.png')); ?>"
                                                    alt="No Items In Cart">
                                                <br><br>
                                                <a href="<?php echo e(route('shop')); ?>" class="btn btn-primary text-white"><em
                                                        class="fa fa-chevron-left  mr-1"></em><?php echo e(__('msg.continue_shopping')); ?></a>
                                            </div>
                                            <?php endif; ?>
                                        </div>
                ...
                <div class="col-lg-3 col-md-6 mb-sm-2 mb-2 mb-md-0">
                    <div class="categories_menu">
                        ...
                        <div class="title_content">
                            ...
                            <h2 class="categories_toggle"><em
                                    class="fas fa-bars"></em><?php echo e(__('msg.all_categories')); ?></h2>
                            ...
                            <ul>
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(isset($c->childs) && count((array) $c->childs)): ?>
                                        <li
                                            class="menu_item_content has_child <?php echo e($loop->index >= $maxProductToShowhere ? 'hidden' : ''); ?>">
                                            <a href="<?php echo e(route('category', $c->slug)); ?>"><?php echo e($c->name); ?></a><em
                                                class="fas fa-plus fa-xs"></em>
                                    ...
                                    <?php else: ?>
                                        <li
                                            class="menu_item_content not_child <?php echo e($loopn >= $maxProductToShowhere ? 'hidden' : ''); ?>">
                                            <a href="<?php echo e(route('category', $c->slug)); ?>"><?php echo e($c->name); ?> </a>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php else: ?>
                                        <?php if($maxProductToShow == 0): ?>
                                            <li>
                                                <a href="#" id="more-btn"><em class="fa fa-plus"
                                                        aria-hidden="true"></em>
                            ...
                            <form action="<?php echo e(route('shop')); ?>">
                                ...
                                <div class="search-box">
                                    <input placeholder="Search product..."
                                        ...
                                        type="text" class="typeahead search" autocomplete="off" id="searchm">
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('home')); ?>"
                                        class="<?php echo e(request()->is('/') ? 'active' : ''); ?>"><?php echo e(__('msg.home')); ?>

                                    </a>
                                </li>
                                <li class="mega_items_content"><a href="<?php echo e(route('shop')); ?>"
                                        class="<?php echo e(request()->is('shop') ? 'active' : ''); ?>"><?php echo e(__('msg.shop')); ?></a>
                                </li>
                                <li>
                                    <a><?php echo e(__('msg.more')); ?><em class="fa fa-angle-down"></em></a>
                                    <ul class="sub_menu pages">
                                        <li><a href="<?php echo e(route('about')); ?>"
                                                class="<?php echo e(request()->is('about') ? 'active' : ''); ?>"><?php echo e(__('msg.about us')); ?></a>
                                        </li>
                                        <li><a href="<?php echo e(route('page', 'faq')); ?>"
                                                class="<?php echo e(request()->is('page/contact') ? 'active' : ''); ?>"><?php echo e(__('msg.faq')); ?></a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="<?php echo e(route('contact')); ?>"
                                        class="<?php echo e(request()->is('contact') ? 'active' : ''); ?>">
                                        <?php echo e(__('msg.contact us')); ?></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
    ...
    <!--header area end-->
    <!-- modal area start-->
    <div class="modal fade" id="productvariant" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div id='loader2'>
        <img src="<?php echo e((asset('images/loading.gif') == '') ? asset('images/loading.gif') : URL::asset('images/headerlogo.png')); ?>" id="preloader" alt="preloader">
    </div>
                ...
                <div class="modal-body">
                    <div class="wrapper-dropdown-5 dd" tabindex="1">
                        <?php if(Cache::has('locations') && is_array(Cache::get('locations')) && !empty(Cache::get('locations')['data'])): ?>
                            <input class="inP live-search-box form-control" type="text" name="selected_pincode"
                                placeholder="<?php echo e(session()->get('pincode_no')); ?>" autocomplete="off"
                                onkeyup="searchclick()" id="searchclick">
                            <ul class="dropdown live-search-list">
                                <li class="item">
                                    <a class="close-pincode-modal" href="<?php echo e(route('home-pincode-clear')); ?>">
                                        <?php echo e(__('msg.all')); ?></a>
                                </li>
                                <?php $__currentLoopData = Cache::get('locations')['data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(!empty($loc->pincode)): ?>
                                        <li class="item">
                                            <a class="close-pincode-modal"
                                                href="<?php echo e(route('home-pincode', $loc->id)); ?>"><?php echo e($loc->pincode); ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
...
<?php /**PATH /home/u743445510/domains/graymatterworks.com/public_html/ecartwebsite/resources/views/themes/eCart/common/header.blade.php ENDPATH**/ ?>