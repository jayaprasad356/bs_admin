...
Route::post('track_order_view', 'UserController@track_order_view')->name('track_order_view');

Route::post('get_shipdel_charge', 'CheckoutController@get_shipdel_charge')->name('get_shipdel_charge');
